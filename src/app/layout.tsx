...
export const metadata: Metadata = {
  title: 'SCENA | Mangueras, conexiones y componentes industriales 24/7',
  ...
  openGraph: {
    ...
    locale: 'es_MX',
    type: 'website',
    images: [{ url: '/catalog/manguera-metalica.webp', width: 800, height: 800, alt: 'Manguera metálica industrial SCENA' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'SCENA — Tu operación no se detiene. Nosotros tampoco.',
    description: SITE.description,
    images: ['/catalog/manguera-metalica.webp'],
  },
}
